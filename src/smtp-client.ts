...
export class SMTPClient extends SMTPChannel {
    ...
    constructor(config: any) {
        ...
        if ((<any>window).require) {
            this._os = (<any>window).require('os');
            this._crypto = (<any>window).require('crypto');
        }
    ...
    */
    public connect(timeout: number = 0) {
        const lines = [];
    ...
    * `timeout` parameter.
    */
    public helo(hostname: string | null = null, timeout: number = 0) {
        if (!hostname) {
    ...
    * `timeout` parameter.
    */
    public ehlo(hostname: string | null = null, timeout: number = 0) {
        if (!hostname) {
            hostname = this._getHostname();
        }
    ...
    */
    public greet(hostname: string | null = null ) {
    ...
    * SMTP server.
    */
    public hasExtension(extension: any) {
    ...
    */
    public parseEnhancedReplyCode(line: string) {
    ...
    */
    public parseReplyText(line: string) {
        const isSupported = this.hasExtension('ENHANCEDSTATUSCODES');
        if (isSupported) {
    ...
    * `timeout` parameter.
    */
    public mail(from: string = null, timeout: number = 0) {
        const lines = [];
        const handler = (line) => lines.push(line);
    ...
    * `timeout` parameter.
    */
    public rcpt(to: string = null, timeout: number = 0) {
        const lines = [];
        const handler = (line) => lines.push(line);
    ...
    * milliseconds by passing the optional `timeout` parameter.
    */
    public data(source: any, sourceSize: number = 0, timeout: number = 0) {
    ...
    * number of milliseconds by passing the optional `timeout` parameter.
    */
    public secure(timeout: number = 0) {
    ...
    */
    public _createSMTPResponseError(lines: any) {
